...
if [ $TEST ]; then
    ...
    lxc exec plat -- systemctl restart dnsmasq
    lxc exec plat -- systemctl restart nginx
    lxc exec plat -- systemctl restart yaks
    lxc exec plat -- systemctl restart mec_platform
    lxc exec plat -- systemctl restart dyndns
